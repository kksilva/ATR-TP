...
PROCESS_INFORMATION ProcessoExibicaoProcesso;	// Informações sobre novo processo criado
PROCESS_INFORMATION ProcessoExibicaoOtimizacao;	// Informações sobre novo processo criado
...
int main() {
    ...
    // 3.3. Cria os dois processos de Exibição de Mensagens
    ...
    status = CreateProcess(
        ...
        NULL,											// lpEnvironment
        "..\\Exibicao\\TarefaExibicaoProcesso\\x64\\Debug\\",  // diretório corrente do filho
        &si,											// lpStartUpInfo
    ...
    status = CreateProcess(
        ...
        NORMAL_PRIORITY_CLASS | CREATE_NEW_CONSOLE,		// CreationFlags
        NULL,											// lpEnvironment
        "..\\Exibicao\\TarefaExibicaoOtimizacao\\x64\\Debug\\",  // diretório corrente do filho
        &si,											// lpStartUpInfo
    ...
    // 6. Finalização de Handles
        // Destruição de outros objetos de sincronização
    FechaObjetos();
